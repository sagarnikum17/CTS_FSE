...
public class ReaderBook {
	...
	private boolean b_isblock;
	
	
	
	public boolean isB_isblock() {
		return b_isblock;
	}

	public void setB_isblock(boolean b_isblock) {
		this.b_isblock = b_isblock;
	}
	...
	public ReaderBook(int a_id, String b_name, String b_category, String b_auther, double b_price, String b_publisher, boolean b_isblock) {
		super();
		this.a_id = a_id;
		this.b_name = b_name;
		this.b_category = b_category;
	...
	public ReaderBook(int b_id, int a_id, String b_name, String b_category, String b_auther, double b_price, String b_publisher, boolean b_isblock )
	{
		this(a_id,b_name,b_category,b_auther,b_price,b_publisher,b_isblock);		
		this.b_id=b_id;
	}
	...
	public String toString() {
		return "Book [b_id=" + b_id + ", a_id=" + a_id + ", b_name=" + b_name + ", b_category=" + b_category
				...
				+ ", b_publishdate=" + b_publishdate + ", b_isblock=" + b_isblock + "]";
	}
